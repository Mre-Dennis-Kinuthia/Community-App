  ...
  return (
    <div className="relative flex items-start gap-6">
      ...
      <div className="relative flex flex-col items-center">
        {!isLast && (
          <div
            className={`absolute top-5 w-px border-l border-dotted border-border ${
              isFirst ? "top-5" : "top-0"
            } h-full`}
          />
        )}
        <div className="relative z-10 flex h-2.5 w-2.5 items-center justify-center rounded-full border-2 border-border bg-background">
